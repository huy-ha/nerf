...
if __name__ == '__main__':
    ...
    cubes = [obj for obj_name, obj in objects.items()
             if 'Cube' in obj_name]
    ...
    for i_scene in range(NUM_SCENES):
        ...
        # randomize scene
        for cube in cubes:
            cube.location.x = random.uniform(-1.5, 1.5)
            cube.location.y = random.uniform(-1.5, 1.5)
            cube.location.z = random.uniform(0.4, 1.6)
            cube.rotation_euler = (
